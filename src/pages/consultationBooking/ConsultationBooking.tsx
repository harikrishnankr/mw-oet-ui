...
import {
  ...
  FilterType,
  FilterWrapper,
} from "../../core/filterWrapper/FilterWrapper";
...
export function ConsultationBooking() {
  ...
  const columns: ColumnsType<DataType> = useMemo(
    () => [
      ...
      {
        title: "In Person Appointment Needed",
        dataIndex: "inPersonAppointment",
        key: "inPersonAppointment",
      },
      {
        title: (
          <div style={{ width: "250px" }}>
            Are you a registered client of any Immigration consultancy in Kerala
            or Abroad?
          </div>
        ),
        dataIndex: "registeredForImmigration",
        key: "registeredForImmigration",
      },
      {
      ...
      {
        title: "Test Appeared",
        dataIndex: "testAppeared",
        key: "testAppeared",
      },
      { title: "Test", dataIndex: "test", key: "test" },
      {
        title: "How did you know about MW?",
        dataIndex: "howDidYouKnow",
        key: "howDidYouKnow",
      },
      {
        title: "Country Preferred",
        dataIndex: "countryPreferred",
        key: "countryPreferred",
      },
      ...
      .then((res: any) => {
        ...
        setResults(
          res.data.docs.map((d: any) => ({
            ...
            registeredForImmigration: d.registeredForImmigration ? "Yes" : "No",
            consultancyName: d.consultancyName || "Nil",
          }))
        );
        setPaginationConfig((c: any) => ({
  ...
  return (
    <PageWrapper
      ...
      actions={[
        <Button key="1" type="primary" onClick={getResultListing}>
          Refresh
        </Button>,
      ]}
    >
